...
export const samplingTemplates: Record<string, SamplingTemplate> = {
  summarize: {
    ...
    userPromptTemplate: 'Please provide a concise summary of the following lifelog content:\n\n{content}',
    modelPreferences: {
      speedPriority: 0.8,
      costPriority: 0.7,
    },
  ...
  extractInfo: {
    ...
    userPromptTemplate: 'Extract {infoType} from the following lifelog:\n\n{content}\n\nProvide the information in a structured format.',
    modelPreferences: {
  ...
  analyzePatterns: {
    ...
    userPromptTemplate: 'Analyze the following lifelog data for patterns and trends:\n\n{content}\n\nFocus on:\n1. Recurring topics\n2. Time patterns\n3. Key relationships\n4. Notable changes',
    modelPreferences: {
  ...
  generateInsights: {
    ...
    userPromptTemplate: 'Based on the following lifelog content, generate actionable insights:\n\n{content}\n\nProvide:\n1. Key observations\n2. Recommendations\n3. Areas for improvement\n4. Opportunities identified',
    modelPreferences: {
      intelligencePriority: 0.9,
      speedPriority: 0.5,
    },
  ...
  compareLifelogs: {
    ...
    userPromptTemplate: 'Compare and contrast the following lifelogs:\n\n{content}\n\nHighlight:\n1. Similarities\n2. Differences\n3. Progress or changes\n4. Patterns across time',
    temperature: 0.3,
    maxTokens: 1000,
  },
};
