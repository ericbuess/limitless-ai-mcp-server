...
Search strategy:
1. First, explore the file structure to understand organization (use LS on ./data/lifelogs)
2. Look for date patterns in the directory structure (YYYY/MM/DD format)
3. Search for relevant keywords and phrases using ripgrep (rg command)
4. Read promising files to find specific information (use Read)
5. If needed, refine your search based on initial findings
